...
<body>
    ...
    <main class="admin-container">
        ...
        <?php if (isset($success_msg)): ?>
            <div style="padding:15px; background:#d4edda; color:#155724; margin-bottom:20px; border-radius:6px; border:1px solid #c3e6cb;">
        ...
        <form method="POST" class="settings-form">
            ...
            <div style="margin-top:30px; text-align:right;">
                <button type="submit" name="update_settings" class="btn-primary" style="padding:12px 30px; font-size:16px;">
                    💾 Lưu cài đặt
                </button>
            </div>
        </form>
        ...
        <div class="settings-section" style="margin-top:40px; background:#f8f9fa; padding:20px; border-radius:8px;">
            ...
            <div style="text-align:center;">
                <img id="qr-preview" src="" alt="QR Preview" style="max-width:300px; border:2px solid #0a2a66; border-radius:8px; display:none;">
